...
ggplot(life_expectancy_bins, aes(x = AgeRange, y = Percentage, fill = AgeRange)) +
  ...
  geom_text(aes(label = paste0(round(Percentage, 2), "%")), vjust = -0.5, size = 2.5) +
  labs(
...
#| tbl-cap: "Cleaned data of average life expectancy of 6 years by different countries."
#| echo: false
#| eval: true
#| warning: false
#| message: false
