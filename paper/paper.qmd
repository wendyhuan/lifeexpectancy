...
The GAM was chosen for this analysis due to its ability to capture non-linear relationships between predictors and the outcome variable, which is essential when dealing with categorical predictors like income group and the
...
#Show the whole graph of cleaned table leab
kable(leab, 
      col.names = names(leab), 
      align = "l", 
      caption = "Life Expectancy over countries and years") 
